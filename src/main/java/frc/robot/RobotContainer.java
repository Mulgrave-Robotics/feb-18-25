...
public class RobotContainer {
        ...
        public Command getAutonomousCommand() {
                return new SequentialCommandGroup(
                                new RunCommand(() -> m_robotDrive.drive(0.2, 0, 0, false), m_robotDrive) // Move forward slowly
                                                .withTimeout(3), // 3 seconds
                                new InstantCommand(() -> m_robotDrive.drive(0, 0, 0, false)) // Stop
                );
        }
}
